...
<head>
    <title>Book Shop | Home :: w3layouts</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="BookShop Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
    ...
    <!-- shop css -->
    <link href="{{asset('assets/css/shop.css" type="text/css'}}"  rel="stylesheet" media="all">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    <div id="home">
                ...
                <div class="container">
                    ...
                    <div class="navbar-header page-scroll">
                        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
                            <span class="sr-only">BookShop/span>
        ...
        <!-- //footer -->
        <div class="cpy-right">
            <p>© 2019 BookShop. All rights reserved | Design by
